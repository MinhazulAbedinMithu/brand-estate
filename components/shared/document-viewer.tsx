...
export function DocumentViewer({
  ...
  const handlePrint = () => {
    toast.success("Printing document...", {
      description: `Dispatched print job for ${documentUrl}.`
    });
  };

  const handleDownload = () => {
    toast.success("Downloading document...", {
      description: `${documentUrl} has been saved to your local directory.`
    });
  };
        ...
        <div className="flex items-center justify-between px-3 sm:px-4 py-3 border-b border-border-default bg-bg-alt/70 select-none shrink-0">
          <div className="flex items-center gap-2 min-w-0 mr-2">
            ...
            <div className="min-w-0">
              <span className="font-bold text-text-primary block truncate text-[11px] sm:text-xs">{documentUrl}</span>
