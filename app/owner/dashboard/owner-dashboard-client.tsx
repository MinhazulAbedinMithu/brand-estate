    ...
    <div className="space-y-8">
      ...
      {currentUser && currentUser.status !== "active" && (
        <div className={cn(
          ...
          {currentUser.status === "unsubmitted" && (
            <Button render={<Link href="/owner/submit-docs" />} size="sm" className="h-8 rounded-xl bg-amber-500 text-black hover:bg-amber-400 font-bold px-4 shrink-0 text-[11px] cursor-pointer">
              Submit Docs
            </Button>
          )}
        </div>
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 border-b border-border-default/60 pb-5">
        <div>
          <h1 className="text-xl sm:text-2xl font-bold font-heading text-text-primary">
            Owner Workspace: <span className="text-accent-primary">Overview</span>
          </h1>
        ...
        <div className="flex gap-2">
          <Button render={<Link href="/owner/listings/new" />} size="sm" className="h-10 rounded-full bg-accent-primary text-white hover:bg-accent-primary-hov font-bold px-5">
            <span className="flex items-center gap-2"><PlusCircle className="h-4 w-4" /> Create Listing</span>
          </Button>
          <Button render={<Link href="/owner/leads" />} size="sm" variant="outline" className="h-10 rounded-full border-border-default hover:bg-bg-elevated text-text-secondary px-5">
            View Leads
          </Button>
        </div>
      </div>
        ...
        <div className="lg:col-span-2 rounded-2xl border border-border-default/60 bg-bg-surface p-5 sm:p-6 shadow-sm space-y-4 flex flex-col justify-between">
          <div className="space-y-4">
            <div className="flex items-center justify-between border-b border-border-default/50 pb-4">
              ...
              <Link href="/owner/listings" className="text-xs text-accent-primary font-bold hover:underline">
                Manage listings
              </Link>
            </div>
        ...
        <div className="rounded-2xl border border-border-default/60 bg-bg-surface p-5 sm:p-6 shadow-sm flex flex-col justify-between">
          <div className="space-y-4">
            <div className="flex items-center justify-between border-b border-border-default/50 pb-4">
              ...
              <Link href="/owner/leads" className="text-xs text-accent-primary font-bold hover:underline">
                Open inbox
              </Link>
            </div>
          ...
          <Button render={<Link href="/owner/leads" />} variant="ghost" className="w-full text-xs font-bold text-accent-primary hover:text-text-primary hover:bg-bg-elevated mt-4 rounded-xl cursor-pointer">
