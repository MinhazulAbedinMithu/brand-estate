...
export function AgentBlogEditClient({ id }: { id: string }) {
  ...
  const handleBlogSubmit = async (
    ...
    try {
      ...
      toast.success("Blog post updated", {
        description: submitStatus === "pending" ? "Your changes are pending moderator review." : "Saved as draft.",
      });
      router.push("/agent/blogs");
    } catch {
