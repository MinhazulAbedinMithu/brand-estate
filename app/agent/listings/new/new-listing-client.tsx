      ...
      <div className="rounded-2xl border border-border-default bg-bg-surface p-5 sm:p-8 shadow-xl space-y-6">
        ...
        {step === 3 && (
          <div className="space-y-6 animate-fade-in">
            ...
            <div className="border-t border-border-default/50 pt-6 space-y-4">
              <h3 className="text-xs font-bold text-text-primary uppercase tracking-wider block">Outdoor Facilities (Nearby Distances)</h3>
              <p className="text-[11px] text-text-muted mt-0.5">Specify estimated distances to nearby public infrastructures (e.g. 2 kms, 800m, 1 km). Leave blank if not applicable.</p>
