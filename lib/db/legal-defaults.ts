...
To access certain features of the platform, such as inquiring about listings, listing properties, or viewing agent credentials, you must create a registered account.
...
* **Zoning Compliance**: Listers must specify the correct zoning reference codes (e.g. MU-R, O-C, I-L, W-D) in accordance with local municipality guidelines.
* **Approval Queue**: Listings uploaded to the platform are subject to moderation and may remain in a "Pending Approval" state until verified by a system moderator. We reserve the right to reject or archive listings that violate our standards.

---

## 4. Fees, Payments, and Services
* **Application Fees**: Prospective tenants submitting property lease applications may be subject to non-refundable application screening fees to cover background and credit scores auditing.
* **Subscription Packages**: Premium packages (e.g. Bronze, Silver, Gold) grant advanced features like increased listing limits, virtual tours, and priority support. Subscriptions are billed in advance on a recurring monthly cycles.

---

## 5. Warranties and Limitation of Liability
**BRAND ESTATE IS A PLATFORM PROVIDER, NOT A REAL ESTATE AGENT OR BROKER.**
...
We collect information that you directly provide to us, as well as metadata gathered automatically during platform interactions.

### 2.1 Personal Information
* **Registration details**: Your name, email address, password, role select configuration, and profile photo.
* **Verification Documents**: To execute identity check verification, we collect your National ID card details, including photo uploads of the document front, document back, and a selfie holding the document.
* **Screening Reports**: We process background check documents and credit check score ratings provided via our integration partners.

### 2.2 Automatically Collected Data
* Browser parameters, device type, IP address, geographical locations (for location selectors), and usage histories (such as properties viewed or searches run).
...
* Prevent fraudulent listings and protect against security breaches.
* Provide support emails and newsletter updates (where subscribed).

---

## 4. Information Sharing and Disclosure
We do not sell your personal data. We share your information only under the following conditions:
* **With Property Agents & Owners**: When you submit a property inquiry or tenancy application, your basic profile info and verification statuses (Approved/Pending) are visible to the listing agent/owner.
* **With Verification Providers**: We share NID/KYC parameters and screening documents with third-party background and credit scoring agencies to execute reports.
* **Under Legal Mandate**: If required to do so by law, or in response to valid requests by public authorities.

---

## 5. Data Security & Retention
* We implement industry-standard technical security practices (including database SSL encryptions and secure iframe tokenization) to protect your files.
* Your NID and verification documents are stored securely using Cloudflare R2 bucket storage with obfuscated URLs.
* We retain your information for as long as necessary to fulfill the purposes outlined in this policy or comply with regulatory audits.

---

## 6. Your Rights
Depending on your region (e.g., GDPR in the UK/EU, CCPA in the US), you may have the right to:
...
* **Authentication**: We use the HttpOnly cookie \`be_auth_token\` to securely authorize your logged-in state across page renders and protect role-based routing directories.
* **Theme Preference**: Stores your selected viewing layout mode (Light vs. Dark mode).

### 2.2 Analytical and Performance Cookies
* Allow us to recognize and count the number of visitors and see how users move around our platform when using it. This helps us improve the user journey (e.g., ensuring search filters work correctly).

### 2.3 Targeting and Advertising Cookies
* Record your visit to our website, the pages you have visited, and the links you have followed. We use this information to make our platform more relevant to your property interests.
...
## 2. Investment and Calculator Projections
The platform provides an Investment and Yield Calculator for estimates and educational purposes only.
* **Calculations**: Projections for price appreciation, rental yield ratios, closing costs, and 10-year cumulative projections are estimated using standard variables.
* **Not Advisory**: These calculations do not represent financial or professional investment advice. Real estate investments involve risk, and past performance is not indicative of future yield trends.
