...
- [x] **Payment Module & Wallet System COMPLETE** ✅
  ...
  - [x] **Listings Video Upload Functionality COMPLETE** ✅
...
- **Location-Specific Properties & Selector Rebranding**:
  - Added the `country` field to the `PropertySchema` and `BaseProperty` type mapping definitions, and updated the seeding script ([seed/route.ts](file:///Users/minhaz/Documents/projects/brand/brand-estate/app/api/properties/seed/route.ts)) to resolve/save countries based on listing cities (seeding extra properties in India and Bangladesh).
  - Redesigned the SearchModal location selection tab ([search-modal.tsx](file:///Users/minhaz/Documents/projects/brand/brand-estate/components/shared/search-modal.tsx)) to enforce a step-by-step selection flow: users select a country first, then choose or search from a list of large/important cities for that country.
  - Configured `Navbar` ([navbar.tsx](file:///Users/minhaz/Documents/projects/brand/brand-estate/components/layout/navbar.tsx)) to load and persist city and country selections via cookies (`user_city`, `user_country`), resolving geolocation as a default.
  - Wired Homepage ([page.tsx](file:///Users/minhaz/Documents/projects/brand/brand-estate/app/page.tsx)) and Properties search page ([page.tsx](file:///Users/minhaz/Documents/projects/brand/brand-estate/app/properties/page.tsx)) to read location cookies and filter database queries, with automatic country/global grace fallbacks on empty matches.
  - Fixed client-side serialization errors (objects with `toJSON` methods / nested MongoDB ObjectId buffers) in the search page list query ([page.tsx](file:///Users/minhaz/Documents/projects/brand/brand-estate/app/properties/page.tsx)) and related properties block ([related-listings.tsx](file:///Users/minhaz/Documents/projects/brand/brand-estate/components/property/related-listings.tsx)) by running query results through `JSON.parse(JSON.stringify(docs))` prior to mapping.
  - Implemented an automatic backend migration/backfill in both the homepage ([page.tsx](file:///Users/minhaz/Documents/projects/brand/brand-estate/app/page.tsx)) and search list page ([page.tsx](file:///Users/minhaz/Documents/projects/brand/brand-estate/app/properties/page.tsx)) that runs on load to backfill the newly introduced `country` field for any pre-existing/legacy database properties.
  - Added the Country selection dropdown to the location step (Step 2 of 6) in the listing creation and edit wizard forms for both owners ([new-listing-client.tsx](file:///Users/minhaz/Documents/projects/brand/brand-estate/app/owner/listings/new/new-listing-client.tsx), [edit-listing-client.tsx](file:///Users/minhaz/Documents/projects/brand/brand-estate/app/owner/listings/%5Bid%5D/edit/edit-listing-client.tsx)) and agents ([new-listing-client.tsx](file:///Users/minhaz/Documents/projects/brand/brand-estate/app/agent/listings/new/new-listing-client.tsx), [edit-listing-client.tsx](file:///Users/minhaz/Documents/projects/brand/brand-estate/app/agent/listings/%5Bid%5D/edit/edit-listing-client.tsx)), mapping it to the submit/update request payloads.
